                ...
                {sidebarOpen && (
                  <div className={`dropdown-container ${inventoryDropdownOpen ? 'open' : ''}`}>
                    <div className="dropdown-content space-y-1">
                      ...
                      <button
                        onClick={() => setCurrentPage('inventory_ppe')}
                        className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-all ${currentPage === 'inventory_ppe'
                          ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 font-bold'
                          : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-700'
                          }`}
                      >
                      ...
                      <button
                        onClick={() => setCurrentPage('inventory_uniforms')}
                        className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-all ${currentPage === 'inventory_uniforms'
                          ? 'text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 font-bold'
                          : 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-700'
                          }`}
                      >
                  ...
                  currentPage === 'inventory_equipment'
                    ...
                    : currentPage === 'inventory_fixed_assets'
                      ...
                      : currentPage === 'inventory_ppe'
                        ? "ppe_inventory"
                        : currentPage === 'inventory_uniforms'
                          ? "uniforms_inventory"
